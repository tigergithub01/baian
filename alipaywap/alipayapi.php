...
//服务器异步通知页面路径
$notify_url = "http://www.123121.com/alipaywap/notify_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//页面跳转同步通知页面路径
$call_back_url = "http://www.123121.com/alipaywap/call_back_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//操作中断返回地址
$merchant_url = "http://www.123121.com/alipaywap/merchant_url.php";
...
$seller_email = '13612878838@139.com';
$subject = $_GET['order_sn'];
$out_trade_no = $_GET['order_sn'].$_GET['log_id'];
//$out_trade_no = $_GET['order_sn'];
$total_fee =$_GET['order_amount'];// 0.01;//$_GET['order_amount'];
...
//建立请求
$alipaySubmit = new AlipaySubmit($alipay_config);
$html_text = $alipaySubmit->buildRequestForm($parameter, 'get', '使用支付宝支付');
