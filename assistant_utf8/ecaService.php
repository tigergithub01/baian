...
function hello($name) {
    ...
    return base64_encode('Hello, ' . $name. ';====================;ASSISTANT_VERSION: 1.31 20121206;ECS_CHARSET: '.ECS_CHARSET.';====================;EC_CHARSET: '.EC_CHARSET.';VERSION: '.VERSION.';RELEASE: '.RELEASE.';PHP_VERSION: '.PHP_VERSION);
}
...
function getParas($username, $password, $delimiter_rn = "51eca_rn", $delimiter_cn = "51eca_cn")
{
	...
	$params = $params.$delimiter_rn.'EC_CHARSET'.$delimiter_cn.strtolower(EC_CHARSET);
	...
	$params = $params.$delimiter_rn.'ASSISTANT_VERSION'.$delimiter_cn.'1.30';
