...
$modules['03_promotion']['16_momsuit_list']         = 'momsuit.php?act=list'; //准妈妈套装
...
$modules['04_order']['11_deposit_list']             = 'deposit.php?act=list'; //奶粉寄存
...
$modules['11_system']['content_key']             = 'content_key.php?act=list';  // 关键词自动内链 by pgge
...
//add by pgge
$modules['17_card_and_card']['ks_card_cat']         = 'ks_card.php?act=cat';//礼品卡分类
$modules['17_card_and_card']['ks_card_list']        = 'ks_card.php?act=list';//礼品卡管理
$modules['17_card_and_card']['ks_card_order']       = 'ks_card.php?act=order';//礼品卡订单
$modules['17_card_and_card']['kt_card_list']        = 'kt_card.php?act=list';//储值卡管理
$modules['17_card_and_card']['kt_card_order']       = 'kt_card.php?act=order';//储值卡订单
?>
