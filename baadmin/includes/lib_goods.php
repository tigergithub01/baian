...
function get_attr_list($cat_id, $goods_id = 0)
{
    ...
    $sql = "SELECT a.attr_id, a.attr_name, a.attr_input_type, a.attr_type, a.attr_values, v.attr_value, v.attr_price, v.goods_attr_id ".
            ...
            "ORDER BY a.sort_order, a.attr_type, a.attr_id, v.attr_price, v.goods_attr_id";  //代码修改 By www.68ecshop.com 增加 , v.goods_attr_id
...
function reformat_image_name($type, $goods_id, $source_img, $position='')
{
    ...
    if (!make_dir(ROOT_PATH.$dir.'/'.$sub_dir.'/qr_code'))
    {
        return false;
    }
