 ...
 * ============================================================================
 * $Author: LaiGuangming $
 * $Id: sfdf_express.php 17217 2014-01-09 15:03:12 LaiGuangming $
 */
...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/sfdf_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'sfdf_express_desc';

    /* 配送方式是否支持货到付款 */
    $modules[$i]['cod']     = true;

    /* 插件的作者 */
    $modules[$i]['author']  = 'LaiGuangming';

    /* 插件作者的官方网站 */
    $modules[$i]['website'] = 'http://www.suntop168.com';
...
class sfdf_express
{
     ...
     * @return null
     */
    function sfdf_express($cfg=array())
    {
