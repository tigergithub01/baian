 ...
 * ============================================================================
 * $Author: LaiGuangming $
 * $Id: yto.php 17217 2014-01-09 16:40:23 LaiGuangming $
 */
...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/stodf_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'stodf_express_desc';
...
class stodf_express
{
     ...
     * @return null
     */
    function stodf_express($cfg=array())
    {
