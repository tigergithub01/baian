 ...
 * @return  array
 */
$children = get_children(386);//此处为产品分类ID
...
if (!$smarty->is_cached('index2015.dwt', $cache_id))
...
//    $smarty->assign('page_title',      $position['title']);    // 页面标题
    ...
    $good=index_get_cat_id_goods_best_list(344,9);
    /* meta information */
	...
	$F4=tui_product(335,8);//四楼精品
	$F5=tui_product(334,8);//五楼楼精品
	$F6=tui_product(337,8);//六楼精品
	$F7=tui_product(339,8);//7楼精品
    $smarty->assign('F1',$F1);
	$smarty->assign('F2',$F2); 
    $smarty->assign('F3',$F3); 
    $smarty->assign('F4',$F4); 
...
$smarty->display('index2015.dwt', $cache_id);
...
function  tui_product($id,$num){
	...
	function get_ecs_category_idsz( $id )
{
    $ids = "";
