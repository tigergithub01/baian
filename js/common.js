...
function opencartDiv(price, name, pic, goods_brief, goods_id, total, number) {
    ...
    //生成层内内容
    html = '<div class="cardivfloat"><span class="cartdivfloattitle">商品已成功添加到购物车！</span><a href=\'javascript:cancel_div()\' style="float:right;padding:0 26px 0 0;background:url(themes/baian/images/ico_closebig1.gif) right center no-repeat;cursor:pointer;color:#ffffff;font-size:12px;" >关闭</a></div><div class="cartpopDiv"><div class="toptitle"><a href="goods.php?id=' + goods_id + '" class="pic"><img src=' + pic + ' width="98" height="98" style="border:#dddddd 1px solid; display:block;"/></a><p><font style="font-weight:bold">' + name + '</font>  <br>' + goods_brief + '<br>购买价格：<font style="color:#cc0000">' + price + '</font><br></p></div>';
    ...
    html += "<div class='cartbntfloat' ><a href='flow.php'><img src='themes/baian/images/jsico1.gif'></a><a href=\'javascript:cancel_div()\'><img src='themes/baian/images/goon_ico1.gif'></a></div>";
    html += '</div></div>';
...
* 添加商品到购物车(准妈妈套装的)
*/
function momsuitToCart(goodsId, market_price, parentId) {
    var goods = new Object();
    var spec_arr = new Array();
    var fittings_arr = new Array();
    var number = 1;
    ...
    Ajax.call('flow.php?step=add_to_cart', 'goods=' + goods.toJSONString() +'&is_momsuit=1', momsuitToCartResponse, 'POST', 'JSON');
}



/* *
* 处理添加商品到购物车的反馈信息(准妈妈套装的)
*/
function momsuitToCartResponse(result) {
    if (result.error < 1) {
