...
$_LANG['content_key'] = '关键词内链设置'; // 关键词自动内链 by pgge
...
$_LANG['11_deposit_list'] = '寄存列表';
$_LANG['16_momsuit_list'] = '准妈妈套装';
$_LANG['deposit_sn'] = '订单号';
$_LANG['deposit_dq'] = '到期';
$_LANG['oper_sta'] = '处理状态';
