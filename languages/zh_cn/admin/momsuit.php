...
$_LANG['tab_desc'] = '套装介绍';
$_LANG['tab_goods'] = '套装商品';
$_LANG['tab_advanced'] = '高级选项';
$_LANG['back_list'] = '返回套装列表';
$_LANG['continue_add'] = '继续添加套装';
$_LANG['topic_class'] = '套装分类';
...
/* 提示信息 */
$_LANG['succed'] = '操作成功!';
$_LANG['notice_template_file'] = '填写当前套装的模板文件名,模板文件应上传到当前商城模板目录下,不填写将调用默认模板。';
$_LANG['notice_css'] = '填写当前套装的CSS样式代码,不填写将调用模板默认CSS文件';
$_LANG['js_languages']['topic_name_empty'] = '请输入套装标题!';
...
$_LANG['js_languages']['sort_googs_empty'] = '请选择套装商品!';
...
/* 套装信息字段 */
$_LANG['topic_id'] = '编号';
$_LANG['momsuit_title'] = '套装标题';
$_LANG['momsuit_price'] = '套装价格';
$_LANG['start_time'] = '开始时间';
$_LANG['end_time'] = '结束时间';
$_LANG['cycle'] = '活动周期';
$_LANG['template_file'] = '套装模板文件';
$_LANG['style_sheet'] = '套装样式表';
$_LANG['lable_topic_type'] = '图片类型';
$_LANG['lable_base_style'] = '基本风格样式';
$_LANG['lable_title_upload'] = '商品分类标题图片';
$_LANG['lable_topic_keywords'] = '套装页面关键字';
$_LANG['lable_topic_description'] = '套装页面描述';
