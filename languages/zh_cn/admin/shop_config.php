...
$_LANG['cfg_name']['free_shipping_region'] = '脚印评估运费地区';
$_LANG['cfg_name']['free_shipping_region_value'] = '免运费地区';

$_LANG['cfg_name']['JYXL_BL'] = '脚印笑脸比例';
$_LANG['cfg_desc']['JYXL_BL'] = '注意：修改完比例后，商品的笑脸显示将改变';

$_LANG['cfg_name']['JYXL_MYF'] = '免运费脚印值';
$_LANG['cfg_name']['JYXL_XDTS'] = '免运费下单提示';

$_LANG['cfg_name']['birthday_prompt'] = '宝宝生日提示(天)';
...
$_LANG['cfg_name']['sign_day_rank_points'] = '每日签到增加成长值';
...
$_LANG['cfg_range']['upload_size_limit']['8192'] = '8MB';
