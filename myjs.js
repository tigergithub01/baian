...
if (typeof pageConfig.FN_getDomain === "undefined") {
    pageConfig.FN_getDomain = function () {
        ...
        return (/#/.test(a)) ? "#" : "jd.com"
    }
} (function () {
    var a = document.getElementById("nav-minitiao");
    if (!!a) {
        a.innerHTML = '<a href="http://dapeigou.jd.com/" target="_blank">\u642d\u914d\u8d2d</a>';
        a.setAttribute("id", "nav-dapeigou")
    }
})(); (function () {
    ...
    b = 0;
    if (!!a) {
        c = a.getElementsByTagName("dl")[4].getElementsByTagName("div");
        while (b < c.length) {
            if (/\u5bb6\u7535\u4e0b\u4e61/.test(c[b].innerHTML)) {
    ...
    function e(b, k) {
        if (k = k || document, k.getElementsByClassName) {
            return k.getElementsByClassName(b)
        }
        for (var j = k.getElementsByTagName("*"), h = [], g = 0; j.length > g; g++) {
            d(b, j[g]) && h.push(j[g])
        }
        return h
    }
    function d(h, g) {
        for (var k = g.className.split(/\s+/), j = 0; k.length > j; j++) {
            if (k[j] == h) {
                return !0
            }
        }
...
var TrimPath; (function () {
    ...
    a.fn.Jlazyload = function (j, n) {
        ...
        var f = a.extend({
            ...
            placeholderImage: "#/lib/img/e/blank.gif",
...
function getparam() {
    ...
    a.jdCalcul = function (g) {
        var b = null;
        var g = g.join(",");
        var e = "http://qiang.jd.com/HomePageLimitBuy.ashx?callback=?&ids=" + g;
...
var jdModelCallCenter = {
    ...
    login: function () {
        ...
        setTimeout(function () {
            $.jdThickBox({
                type: "iframe",
                title: "\u60a8\u5c1a\u672a\u767b\u5f55",
                source: "http://passport." + pageConfig.FN_getDomain() + "/new/LoginFrame.aspx?clstag1=" + c.settings.clstag1 + "&clstag2=" + c.settings.clstag2 + "&r=" + Math.random(),
                width: 450,
                height: 360,
                _title: "thicktitler",
                _close: "thickcloser",
    ...
    regist: function () {
        ...
        setTimeout(function () {
            $.jdThickBox({
                type: "iframe",
                title: "\u60a8\u5c1a\u672a\u767b\u5f55",
                source: "http://passport." + pageConfig.FN_getDomain() + "/new/registPersonalFrame.aspx?clstag1=" + a.settings.clstag1 + "&clstag2=" + a.settings.clstag2 + "&r=" + Math.random(),
                width: 450,
                height: 500,
                _title: "thicktitler",
                _close: "thickcloser",
    ...
    init: function () {
        var a = this;
        $.ajax({
            url: "http://passport." + pageConfig.FN_getDomain() + "/new/helloService.ashx?m=ls&sso=0",
            dataType: "jsonp",
            success: function (b) {
                a.tbClose();
                if (b && b.info) {
...
$.extend(jdModelCallCenter, {
    doAttention: function (a) {
        var b = "http://t." + pageConfig.FN_getDomain() + "/regard/follow.action?callback=?";
        $.login({
            modal: true,
            complete: function (c) {
                if (c != null && c.IsAuthenticated != null && c.IsAuthenticated) {
                    if (a > 0) {
                        ...
                        function (e) {
                            if (e.code != null) {
                                ...
                                $.jdThickBox({
                                    type: "iframe",
                                    source: "http://t." + pageConfig.FN_getDomain() + "/subscriber/jumpSubPageNew.action?code=" + e.code + "&pid=" + a + "&t=" + Math.random(),
                                    width: g,
                                    height: d,
                                    title: "\u63d0\u793a",
                                    _box: "attboxr",
...
var category = {
    OBJ: $("#_JD_ALLSORT"),
    URL_Serv: "#/ajaxservice.aspx?stype=SortJson",
    URL_BrandsServ: "#/lishi.aspx?callback=category.getBrandService&id=a,915,925^b,916,926^c,917,927^d,918,928^e,919,929^f,920,930^g,921,931^h,922,932^i,923,933^j,924,934^k,2096,2097^l,3512,3513^m,5274,5275",
    ...
    DATA_Simple: {
        ...
        {
            l: "http://channel.jd.com/1620-1622.html",
            n: "\u5bb6\u5177"
        },
        {
            l: "http://channel.jd.com/1620-4957.html",
            n: "\u5bb6\u88c5"
        },
        {
    ...
    TPL_Items: '{for item in data}		{var x=category.FN_GetX(item.t)}		<div class="item fore${parseInt(item_index)+1}">			<span clstag="homepage|keycount|home2012|0${601+parseInt(item_index)}a"><h3>${item.n}</h3><s></s></span>			<div class="i-mc">				<div onclick="$(this).parent().parent().removeClass(\'hover\')" class="close"></div>				<div class="subitem" clstag="homepage|keycount|home2012|0${601+parseInt(item_index)}b">					{for subitem in item.i}					<dl class="fore${parseInt(subitem_index)+1}">						<dt>							${category.FN_GetLink(1,subitem)}						</dt>						<dd>{for link in subitem.i}<em>${category.FN_GetLink(x,link)}</em>{/for}</dd>					</dl>					{/for}				</div>				<div class="cat-right-con fr" id="JD_sort_${item.t}"><div class="loading-style1"><b></b>\u52a0\u8f7d\u4e2d\uff0c\u8bf7\u7a0d\u5019...</div></div>			</div>		</div>		{/for}<div class="extra"><a clstag="homepage|keycount|home2012|0614a" href="http://www.jd.com/allSort.aspx">\u5168\u90e8\u5546\u54c1\u5206\u7c7b</a></div>',
...
var UC = {
    DATA_Cookie: "aview",
    TPL_UnRegist: '<div class="prompt">			<span class="fl">\u60a8\u597d\uff0c\u8bf7<a href="javascript:login()" clstag="homepage|keycount|home2012|04a">\u767b\u5f55</a></span>			<span class="fr"></span>		</div>',
    ...
    TPL_UList: '<div class="uclist">				<ul class="fore1 fl">					<li><a target="_blank" clstag="homepage|keycount|home2012|04b" href="http://jd2008.jd.com/JdHome/OrderList.aspx">\u5f85\u5904\u7406\u8ba2\u5355<span id="num-unfinishedorder"></span></a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04c" href="http://jd2008.jd.com/user_spzx.aspx">\u54a8\u8be2\u56de\u590d<span id="num-consultation"></span></a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04d" href="http://t.jd.com/home/follow?page=1&m_m=1&r_r=1">\u964d\u4ef7\u5546\u54c1<span id="num-reduction"></span></a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04e" href="http://coupon.jd.com/user_quan.aspx">\u4f18\u60e0\u5238<span id="num-ticket"></span></a></li>				</ul>				<ul class="fore2 fl">					<li><a target="_blank" clstag="homepage|keycount|home2012|04f" href="http://jd2008.jd.com/JdHome/OrderList.aspx">\u6211\u7684\u8ba2\u5355&nbsp;&gt;</a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04i" href="http://t.jd.com/home/follow">\u6211\u7684\u5173\u6ce8&nbsp;&gt;</a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04g" href="http://bankws.jd.com/score/Integral/ScoreExhibit.aspx">\u6211\u7684\u79ef\u5206&nbsp;&gt;</a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04h" href="http://my.jd.com/personal/guess.html">\u4e3a\u6211\u63a8\u8350&nbsp;&gt;</a></li>				</ul>			</div>',
    TPL_VList: {
    ...
    FN_InitOList: function () {
        ...
        $.ajax({
            url: "#/index.php?mod=Consultation&action=havingReplyCount",
            dataType: "jsonp",
            success: function (a) {
                if (a) {
        ...
        $.ajax({
            url: "http://t.#/follow/followProductCount.action",
            data: {
                method: "GetCount"
            },
            dataType: "jsonp",
...
var MCART = {
    ...
    FN_BindEvents: function () {
        var a = this;
        $("#settleup-content .delete").bind("click",
        function () {
    ...
    FN_Refresh: function () {
        ...
        a = function (h) {
            var e = h.Cart,
            l = e.TheSkus.length + e.TheSuit.length + e.TheGifts.length + e.ManJian.length + e.ManZeng.length,
            f = MCART.TPL_List.sigle.process(h.Cart),
            j = MCART.TPL_List.gift.process(h.Cart),
            o = MCART.TPL_List.suit.process(h.Cart),
            n = MCART.TPL_List.mz.process(h.Cart),
            k = MCART.TPL_List.mj.process(h.Cart);
            if (l > 0) {
...
var NotifyPop = {
    ...
    checkLogin: function (a) {
        ...
        $.getJSON("http://passport." + pageConfig.FN_getDomain() + "/loginservice.aspx?method=Login&callback=?",
        function (b) {
            if (b.Identity) {
                a(b.Identity)
            }
    ...
    $.ajax({
        url: "http://passport." + pageConfig.FN_getDomain() + "/new/helloService.ashx?m=ls",
        dataType: "jsonp",
    ...
    function (b) {
        ...
        $.login({
            ...
            complete: function (f) {
                ...
                var e = b.find("dd").eq(0),
                d = "",
                c = readCookie(UC.DATA_Cookie);
...
var $o = (function (g) {
    ...
    var o = "\u641C\u7D22\u5386\u53F2";
    var e = '<li id="d_#{id}" suggest-pos="#{suggest_pos}" title="#{title}" onclick="$o.clickItem(this)" history="1"><div class="search-item" style="color:#005AA0">#{keyword}</div><div class="search-count">' + o + "</div></li>";
    var h = '<li id="d_#{id}" suggest-pos="#{suggest_pos}" title="#{title}" onclick="$o.clickItem(this)"><div class="search-item">#{keyword}</div><div class="search-count">\u7EA6#{amount}\u4E2A\u5546\u54C1</div></li>';
    var b = '<div id="d_#{id}" suggest-pos="#{suggest_pos}" class="#{className}" title="#{title}" cid="#{cid}" cLevel="#{cLevel}" onclick="$o.clickItem(this)"><div class="search-item">\u5728<strong>#{cname}</strong>\u5206\u7c7b\u4e2d\u641c\u7d22</div><div class="search-count">\u7EA6#{amount}\u4E2A\u5546\u54C1</div></div>#{categorys}';
    var k = '<li class="fore1"><div id="d_#{id}" suggest-pos="#{suggest_pos}" class="fore1" title="#{title}" onclick="$o.clickItem(this)"><div class="search-item">#{keyword}</div><div class="search-count" #{style}>\u7EA6#{amount}\u4E2A\u5546\u54C1</div></div>#{categorys}</li>';
    var n = "http://dd.search.jd.com/?key=#{keyword}&uid=#{uid}";
    var m = "#FFDFC6";
    var c = "#FFF";
    var l = $("#key");
    var p = $("#shelper");
    ...
    a.prototype.clickItem = function (t) {
        var s = t.getAttribute("cid");
        if (null != s && "" != s) {
            search.cid = s
        } else {
            search.cid = null
        }
        var q = t.getAttribute("cLevel");
        if (null != q && "" != q) {
            search.cLevel = q
        } else {
            search.cLevel = null
        }
        var u = t.getAttribute("ev_val");
        if (null != u && !u.trim().isEmpty()) {
            search.ev_val = u
        } else {
            search.ev_val = null
        }
        ...
        search.additinal = "&suggest=" + t.getAttribute("suggest-pos");
        search("key")
    };
    a.prototype.mouseenter = function (s) {
        var s = $(s);
        if (s.attr("history")) {
            s.find(".search-count").html(d)
        }
        s.css("background", m);
        if (-1 != this.index && $.trim(s.attr("id"))) {
            var r = s.attr("id").split("_");
            if (2 == r.length) {
                var q = parseInt(r[1], 10);
                if (q != this.index) {
                    $("#d_" + this.index).css("background", c);
                    this.index = q
                }
            }
        }
    ...
    a.prototype.mouseleave = function (q) {
        q.css("background", c);
        if (q.attr("history")) {
            q.find(".search-count").html(o)
        }
        this.needCreatedItem = false
    };
    a.prototype.selectItemNode = function (v) {
        var u = this;
        var t = $("#d_" + u.index + ":visible");
        t.css("background-color", c);
        if (t.attr("history")) {
            t.find(".search-count").html(o)
        }
        u.index = (u.length + u.index + v) % u.length;
        var w = $("#d_" + u.index);
        if (w.length > 0) {
            if (w.attr("history")) {
                w.find(".search-count").html(d)
            }
            w.css("background-color", m);
            var r = w.attr("title");
            if (null != r && !r.trim().isEmpty()) {
                l.val(r)
            }
            ...
            search.ev_val = null;
            search.additinal = "&suggest=" + w.attr("suggest-pos")
        }
    };
    ...
    a.prototype.keydown_up = function (s) {
        var r = this;
    ...
    a.prototype.onloadItems = function (I) {
        var J = l.val().trim();
        if ("" == J) {
            p.html("").hide();
            return
        ...
        if (window.pageConfig && window.pageConfig.searchType) {
            z = window.pageConfig.searchType
        }
        var K = 0,
        C = "",
        A = false;
        ...
        w = I.length; G < w; G++) {
            ...
            var D = l.val().trim();
            var r = B.keyword.trim();
            var F = r.toLowerCase().indexOf(D.toLowerCase());
            var q = r;
            if (F == 0) {
                q = D + "<strong>" + r.substring(F + D.length) + "</strong>"
            }
            if ("string" == typeof (B.cid) && !B.cid.trim().isEmpty()) {
                if (A == false) {
                    A = true;
                    var H = 'style="visibility:hidden"',
                    u = 0;
                    if (B.oamount && B.oamount > 0) {
                        u = B.oamount;
                        H = ""
                    }
                    C += f.replace(k, {
                ...
                if ("string" == typeof (B.cname) && B.cname.trim().isEmpty()) {
                    continue
                }
                var x = B.level;
                if (!x) {
                ...
                if (0 == z) {
                    if ("string" == typeof (x) && /^[1-8]4$/.test(x)) {
                        continue
                    }
                } else {
                    if (5 == z) {
                        if ("string" == typeof (x) && !(/^[5-8]2$/.test(x))) {
                            continue
                        }
                    } else {
                        if (1 == z || 2 == z || 3 == z || 4 == z) {
    ...
    a.prototype.del = function (s) {
        ...
        var t = $(s.srcElement ? s.srcElement : s.target),
        q = t.parent().parent().attr("title");
        $.ajax({
            url: "http://search.jd.com/suggest.php?op=del&callback=?&key=" + encodeURIComponent(q),
            dataType: "jsonp",
            scriptCharset: "utf-8",
            success: function (u) {
...
pageConfig.FN_InitContrast = function (d, c, b) {
    var d = d || "_contrast",
    b = b || "list",
    c = c || "#/contrast/js/contrast.js?ver=" + (+new Date),
...
if (self !== top) {
    $("body").append('<iframe src="http://guang.jd.com/static/cross-domain.html" style="display:none;"></iframe>')
};