...
function getStockCallback(result) {
    if (result.stock && (result.stock.code == 3 || result.stock.code == 4) && result.stock.level > 1) {
        ...
        if (result.length > 0) {
            ...
            if(jyHtml){
                jyHtml = '运费评估：' + jyHtml;
                jyHtml += '&nbsp;&nbsp;<span style="color:red;font-size:13px;">（'+JYXL_BL+'<img src=\"themes/baian/images/ba_jyxl_j.gif\" style=\"width:15px; height:15px;\" title=\"脚印\">=1<img src=\"themes/baian/images/ba_jyxl_l.gif\" style=\"width:20px; height:20px;\" title=\"笑脸\">'+
                		  '全场商品累积满'+parseInt(JYXL_MYF / JYXL_BL)+'个<img src=\"themes/baian/images/ba_jyxl_l.gif\" style=\"width:20px; height:20px;\" title=\"笑脸\">免运费！）</span>';
            }
