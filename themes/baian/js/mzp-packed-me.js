...
var MagicZoom_ua='msie';var W=navigator.userAgent.toLowerCase();if(W.indexOf("opera")!=-1){
  ...
  this.popupSizeX=100;if(this.settings&&this.settings["header"]!=""){
    ...
    } var ar1 = document.createElement("DIV"); ar1.style.overflow = "hidden"; ar1.className = "MagicZoomFool"; this.bigImageCont.appendChild(ar1); this.bigImage = document.createElement("IMG"); this.bigImage.src = bigimgsrc; this.bigImage.style.position = 'relative'; this.bigImage.style.borderWidth = '0px'; this.bigImage.style.padding = '0px'; this.bigImage.style.left = '0px'; this.bigImage.style.top = '0px'; ar1.appendChild(this.bigImage); var gd56f7fsgd = ['', '#DD0000', 10, 'bold', 'center', '100%', 20]; if ('undefined' !== typeof (gd56f7fsgd)) {
